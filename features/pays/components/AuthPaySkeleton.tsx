...
export default class AuthPaySkeleton extends Component {
  render() {
    return (
      <View className="flex-1 bg-primary dark:bg-dark-background">
        <View className="flex-1 px-5 py-2 rounded-t-3xl bg-background dark:bg-dark-background">
          <View className="flex-row justify-between mb-1">
            <View className="h-10 w-[80%] bg-gray-300 dark:bg-gray-700 rounded mt-2 mb-4 animate-pulse" />
            <View className="h-10 w-[15%] bg-gray-300 dark:bg-gray-700 rounded mt-2 mb-4 animate-pulse" />
          </View>
